...
public class Shipping {
    ...
    public Shipping() {
        ...
        usCities.add(new City("Washington DC", 10.50, true));

        List<City> deCities = new ArrayList<>();
        deCities.add(new City("Berlin", 4.50, true));
        deCities.add(new City("Munich", 4.50, false));
        deCities.add(new City("Arnstadt", 1.00, false));
        deCities.add(new City("Erfurt", 1.50, false));
        ...
        List<City> malCities = new ArrayList<>();
        malCities.add(new City("Kuala Lumpur", 5.50, true));
        malCities.add(new City("Johor Bahru", 3.50, false));

        this.locationsByCountry = new HashMap<>();
        this.locationsByCountry.put("US", usCities);
        this.locationsByCountry.put("UK", ukCities);
        this.locationsByCountry.put("MY", malCities);
